...
import static sl.intertrust.Const.*;
...
public class NotificationTest {
	...
	public void monitor_method_attribute_no_more() throws Exception {
		//NotificationModule.log_only(all);
		NotificationModule.log_only(all ^ source_line ^ return_value^ method_params);
	...
	public void taint() throws Exception {
		...
		non_annotated_code();
		NotificationModule.log_only(all ^ name);
		a.taint();
	...
	public void monitor_class() throws Exception {
		...
		a.change_variables();
		non_annotated_code();
		NotificationModule.log_only(all^attribute_value);
		a.change_variables();
